    ...
    <div className='bg-[#f7f8fc] pt-32' id='pricing'>
      <div className='container mx-auto px-8'>
        <div className='text-center mb-12'> 
            ...
            <p className='text-lg mb-12 md:w-2/3 mx-auto'>Psychotherapy is a non-judgemental and collaborative process. No two encounters are the same 
            and there is no simple definition or right answer. At our Center and online
             recovery program, treating sufferers of trauma, depression, body dysmorphia, anxiety and eating disorders, we reach out to people.</p>
        </div>
